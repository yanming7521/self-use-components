	...
	<view class="container">
		<view class="page-body uni-content-info">
				...
				<view v-if="isShowImg" class="uni-corpper" :style="'width:' + cropperInitW + 'px;height:' + cropperInitH + 'px;'">
					...
					<view class="uni-corpper-content" :style="'width:' + cropperW + 'px;height:' + cropperH + 'px;left:' + cropperL + 'px;top:' + cropperT + 'px'">
						...
						<view class="cropper-modal-box" :style="'left:' + cutL + 'px;top:' + cutT + 'px;right:' + cutR + 'px;bottom:' + cutB + 'px'">
							<img
								:src="imageSrc"
								:style="'width:' + cropperW + 'px;height:' + cropperH + 'px;transform:translate3d(' + cutL * -1 + 'px, ' + cutT * -1 + 'px, 0px) '"
							/>
						</view>
						<view
			...
			<view class="cropper-config">
				<view class="cropper-choose" v-if="showB" :style="'background-color: ' + selectButtonBackgroundColor + ';color: ' + selectButtonColor + ';'" @click="getImage">
					{{ selectButtonText }}
				</view>
				<view class="cropper-confirm" v-if="showB" :style="'background-color: ' + saveButtonBackgroundColor + ';color: ' + saveButtonColor + ';'" @click="getImageInfo">
					{{ saveButtonText }}
				</view>
			</view>
			<canvas
				canvas-id="myCanvas"
				v-if="originalW > 0 && originalH > 0"
				:style="
					'position:absolute;border: 1px solid red; width:' +
						(original ? originalW : imageW) +
						'px;height:' +
						(original ? originalH : imageH) +
